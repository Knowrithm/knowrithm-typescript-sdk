...
export declare class WebsiteService {
     ...
     */
    registerWebsiteSource(payload: RegisterWebsiteSourcePayload, headers?: Record<string, string>): Promise<{
        website_source: WebsiteSource;
    }>;
    /**
     ...
     */
    listWebsiteSources(params?: ListWebsiteSourcesParams, headers?: Record<string, string>): Promise<ListWebsiteSourcesResponse>;
    /**
     * Retrieve a website source along with its crawled pages.
     *
     * Endpoint: `GET /v1/website/source/<source_id>/pages`
     */
    listWebsitePages(sourceId: string, headers?: Record<string, string>): Promise<ListWebsitePagesResponse>;
    /**
     ...
     */
    handshake(payload: WebsiteHandshakePayload, headers?: Record<string, string>): Promise<WebsiteHandshakeResponse>;
}
